...
module AcceptsNestedIds
  ...
  def save_nested_id_associations
    ...
    aggregated_id_associations.each do |nested_id_association|
      next unless instance_variable_get("@#{nested_id_association.ids_attr}")
  ...
  # Dirty tracking for nested associations
  module ClassMethods
    ...
    def accepts_nested_ids_for(*args)
      ...
      nested_id_associations.each do |nested_id_association|
        ...
        #   end
        #
        define_method(nested_id_association.ids_attr.to_s) do
